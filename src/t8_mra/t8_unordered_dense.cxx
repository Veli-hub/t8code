...
template <typename T>
void levelgrid_map<T>::insert(unsigned int level, uint64_t key, const T &data) {
...
template <typename T>
void levelgrid_map<T>::erase(unsigned int level, uint64_t key) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
void levelgrid_map<T>::erase(unsigned int level) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
void levelgrid_map<T>::erase_all() {
...
template <typename T>
typename levelgrid_map<T>::iterator levelgrid_map<T>::begin(unsigned int level) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
typename levelgrid_map<T>::iterator levelgrid_map<T>::end(unsigned int level) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
typename levelgrid_map<T>::const_iterator levelgrid_map<T>::begin(unsigned int level) const {
    check_level(level);  // Check if the level is valid
    return level_map[level].begin();
}
...
template <typename T>
typename levelgrid_map<T>::const_iterator levelgrid_map<T>::end(unsigned int level) const {
    check_level(level);  // Check if the level is valid
    return level_map[level].end();
}
...
template <typename T>
std::optional<T> levelgrid_map<T>::find(unsigned int level, uint64_t key) const {
    check_level(level);  // Check if the level is valid
...
template <typename T>
bool levelgrid_map<T>::contains(unsigned int level, uint64_t key) const {
    check_level(level);  // Check if the level is valid
...
template <typename T>
size_t levelgrid_map<T>::size() const noexcept {
    size_t total_size = 0;
...
template <typename T>
typename levelgrid_map<T>::map& levelgrid_map<T>::operator[](unsigned int level) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
const typename levelgrid_map<T>::map& levelgrid_map<T>::operator[](unsigned int level) const {
    check_level(level);  // Check if the level is valid
    return level_map[level];
}
...
template <typename T>
T& levelgrid_map<T>::get(unsigned int level, uint64_t key) {
    check_level(level);  // Check if the level is valid
...
template <typename T>
const T& levelgrid_map<T>::get(unsigned int level, uint64_t key) const {
    check_level(level);  // Check if the level is valid
...
template <typename T>
void levelgrid_map<T>::check_level(unsigned int level) const {
